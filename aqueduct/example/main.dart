...
class App extends ApplicationChannel {
  ...
  Future prepare() async {
    ...
    final persistentStore =
        PostgreSQLPersistentStore.fromConnectionInfo(db.username, db.password, db.host, db.port, db.databaseName);
  ...
  Controller get entryPoint {
    return Router()
      ...
      ..route('/users/[:id]').link(() => Authorizer(authServer)).link(() => UserController(context, authServer));
  }
}
