...
class StandardListSet extends ResourceController {
  Future<Response> get1(
      @Bind.header("foo") List<String> a, @Bind.header("id") List<String> b, @Bind.query("c") List<String> c) async {
    return Response.ok(null);
  }
}
...
class ParseListSet extends ResourceController {
  Future<Response> get1(
      @Bind.header("foo") List<int> a, @Bind.header("id") List<DateTime> b, @Bind.query("c") List<num> c) async {
    return Response.ok(null);
  }
}
