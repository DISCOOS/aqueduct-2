...
void main() {
  ...
  test("If request body is bound, shows up in documentation for operation with valid ref", () {
    ...
    expect(collectionOperations["post"].requestBody.content["application/json"].schema.referenceURI.path,
...
class A extends ResourceController {
  ...
  @Operation.post()
  Future<Response> createA(@Bind.body() AModel model, @Bind.query("requiredQueryParameter") int q) async {
    return Response.ok(null);
  }

  @Operation.put('id')
  Future<Response> undocumented(@Bind.query("requiredQueryParameter") int q, @Bind.body() AModel body,
