...
void main() {
  group("Alterations", () {
    ...
    setUp(() {
      var dataModel = ManagedDataModel([LoadedSingleItem, DefaultItem, LoadedItem, Container, ExtensiveModel]);
    ...
    test("Adding a unique set", () {
      ...
      expect(builder.schema.tableForName("_ExtensiveModel").uniqueColumnSet, ["indexedValue", "startDate"]);
    });
    ...
    test("Modifying a unique set", () {
      ...
      expect(builder.schema.tableForName("_ExtensiveModel").uniqueColumnSet, ["autoincrementValue", "startDate"]);
    ...
    test("Deleting column", () {
      ...
      expect(
          builder.schema.tableForName("_DefaultItem").columns.firstWhere((sc) => sc.name == "id", orElse: () => null),
          isNull);
    ...
    test("Altering column", () {
      ...
      expect(builder.schema.tableForName("_LoadedItem").columnForName("someIndexedThing").deleteRule,
