  ...
  group("Non-create table generator mappings", () {
    ...
    test("Add simple column", () {
      ...
      var propDesc = ManagedAttributeDescription(
          dm.entityForType(GeneratorModel1), "foobar", getManagedTypeFromType(reflectType(int)), null,
          nullable: true);
    ...
    test("Delete column", () {
      ...
      var schema = Schema.fromDataModel(dm);
      var cmds =
          psc.deleteColumn(schema.tables.first, schema.tables.first.columns.firstWhere((s) => s.name == "validDate"));
    ...
    test("Add index to column", () {
      ...
      var cmds = psc.addIndexToColumn(
          schema.tables.first, schema.tables.first.columns.firstWhere((s) => s.name == "validDate"));
