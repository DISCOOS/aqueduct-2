...
class ManagedAttributeDescription extends ManagedPropertyDescription {
  ManagedAttributeDescription(ManagedEntity entity, String name, ManagedType type, Type declaredType,
...
class ManagedRelationshipDescription extends ManagedPropertyDescription {
  ManagedRelationshipDescription(ManagedEntity entity, String name, ManagedType type, Type declaredType,
  ...
  APISchemaObject documentSchemaObject(APIDocumentContext context) {
    ...
    return APISchemaObject.object({destPk.name: ManagedPropertyDescription._typedSchemaObject(destPk.type)})
      ..title = name;
  }
